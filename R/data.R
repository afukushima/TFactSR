...
##'
##' @keywords datasets
##' @references Essaghir A et al. Nucleic Acids Res. 2010 Jun;38(11):e120. doi: 10.1093/nar/gkq149.
...
##'
##' This was from DEMO data in TFactS (http://www.tfacts.org/). The list corresponds to
##' 18 up-regulated genes and 21 down-regulated genes.
##'
##' @name DEGs39
##' @docType data
##' @aliases DEGs39
...
##' A catalogue of annotated target genes in Arabidopsis thaliana based on AtRegNet and ATRM.
##'
##' The original regulatory network datasets were downloaded from AtRegNet
##' - AGRIS Arabidopsis (http://arabidopsis.med.ohio-state.edu/moreNetwork.html)
##' and ATRM (http://atrm.cbi.pku.edu.cn/), respectively. Then we integrated them based on AGI code.
##'
...
##'
##' @keywords datasets
##' @references Yilmaz A et al. NAR 39:D1118-1122 (2011); Jin JP et al. Mol Biol Evol 32:1767-1773 (2015)
##' @author Atsushi Fukushima
NULL

##' A list of 74 differentially expressed genes (DEGs) from AtGenExpress Stress (UV-B).
##'
##' This was from DEMO data in the Supplemental data (Table S4. Genes regulated by UV-B light stress
##' in roots and shoots; filename: TPJ_3052_sm_TabS4.xls) of the paper by Killian et al. TPJ (2008).
##'
##' The list corresponds to 74 genes up-regulated in roots and shoots 1 hnour after onset of UV-B
##' stress treatment.
##'
##' @name GenesUp_SH1H
##' @docType data
...
##'
##' @keywords datasets
##' @references Killian J et al. Plant J. 2007 Apr;50(2):347-363. doi: 10.1111/j.1365-313X.2007.03052.x
##' @author Atsushi Fukushima
NULL
